    ...
    return (
        <div className="slider-container">
            <div className="price-labels">
                <div className="price-label">Today's Low <br></br><div className='level1'>${todayLow}</div></div>
                ...
                <div className="price-label"><div style={{}}>Today's High </div><div className="level2">${todayHigh}</div></div>
            </div>
